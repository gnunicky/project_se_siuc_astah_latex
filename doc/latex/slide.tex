...
\begin{frame}
 \frametitle{Iterazione 1: Analisi, UC1 contratto CO1 e CO2}
  \begin{table}[!htbp]
...
\begin{frame} [allowframebreaks]
 \frametitle{Iterazione 1: Analisi, UC2 contratto CO3 - CO4}
  \begin{table}[!htbp]
...
\begin{frame} {Iterazione 1 Progettazione: UC2\_AccessRoom - OP2}
   \begin{figure}
     \includegraphics[scale=0.105]{image_astah/Iteration_1_DesignModel/UC2_AccessRoom_SSD_2_getRoomsName.png}{\centering}
...
\begin{frame} {Iterazione 1 Progettazione: UC2\_AccessRoom - OP3}
   \begin{figure}
     \includegraphics[scale=0.115]{image_astah/Iteration_1_DesignModel/UC2_AccessRoom_SSD_3_notify.png}{\centering}
...
\begin{frame} {Iterazione 1 Progettazione: UC2\_AccessRoom - OP4}
   \begin{figure}
     \includegraphics[scale=0.175]{image_astah/Iteration_1_DesignModel/UC2_AccessRoom_SSD_4_sendCommand.png}{\centering}
...
\begin{frame} {Refactoring Iterazione 1: UC2\_AccessRoom - OP1}
   \begin{figure}
     \includegraphics[scale=0.205]{image_astah/Iteration_1_DesignModel_Refactored/UC2_AccessRoom_SSD_1_sendCommand.png}{\centering}
     \caption{SSD - OP1: sendCommand(cmd1) del modello di dominio (figura \ref{fig_UC2_AR_SSD}) }
...
\begin{frame} {Refactoring Iterazione 1: UC2\_AccessRoom - OP2}
   \begin{figure}
     \includegraphics[scale=0.17]{image_astah/Iteration_1_DesignModel_Refactored/UC2_AccessRoom_SSD_2_getRoomsName.png}{\centering}
     \caption{SSD - OP2: getRoomsName() del modello di dominio (figura \ref{fig_UC2_AR_SSD}) }
...
\begin{frame} {Refactoring Iterazione 1: UC2\_AccessRoom - OP4}
   \begin{figure}
     \includegraphics[scale=0.25]{image_astah/Iteration_1_DesignModel_Refactored/UC2_AccessRoom_SSD_4_sendCommand.png}{\centering}
     \caption{SSD - OP4: sendCommand(cmd2) del modello di dominio (figura \ref{fig_UC2_AR_SSD}) }
...
\begin{frame} {Refactoring Iterazione 1: UC2\_AccessRoom - OP6}
   \begin{figure}
     \includegraphics[scale=0.115]{image_astah/Iteration_1_DesignModel_Refactored/UC2_AccessRoom_SSD_6_notifypublic.png}{\centering}
     \caption{SSD - OP6: notifypublic(updateList) del modello di dominio (figura \ref{fig_UC2_AR_SSD}) }
