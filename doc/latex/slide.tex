...
\subsection{Prefazione}
 \begin{frame} {Metodologia Applicata}
  ...
  durante il corso di studi di Ingegneria del Software.
   \begin{figure}
     \includegraphics[scale=0.35]{image/Up_sep.png}{\centering}
 ...
 \begin{frame} {Struttura di UP}
   ...
   \begin{figure}
     \includegraphics[scale=0.25]{image/Up_Structure.png}{\centering}
 ...
 \begin{frame} {Documenti costitutivi del progetto }
