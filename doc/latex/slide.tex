...
\begin{frame} {Iterazione 1: Progettazione - Class Diagram Snuc Server UC1 e UC2}
   \begin{figure}
     \includegraphics[scale=0.155]{image_astah/Iteration_1_DesignModel/ClassDiagramSnucServer.png}{\centering}
...
\begin{frame} {Iterazione 1: Progettazione - Class Diagram Snuc UC1 e UC2}
   \begin{figure}
     \includegraphics[scale=0.169]{image_astah/Iteration_1_DesignModel/ClassDiagramSnuc.png}{\centering}
...
\begin{frame} {Iterazione 1: Progettazione, SSD UC1\_RequestConnection}
   \begin{figure}
...
\begin{frame} {Iterazione 1: Progettazione, SSD UC2\_AccessRoom - OP1}
   \begin{figure}
     \includegraphics[scale=0.168]{image_astah/Iteration_1_DesignModel/UC2_AccessRoom_SSD_1_sendCommand.png}{\centering}
     \caption{SSD - OP1: sendCommand(cmd1) del modello di dominio (figura \ref{fig_UC2_AR_SSD}) }
     \label{fig_UC2_SSD_AC_1} 
   \end{figure}
\end{frame}

\begin{frame} {Iterazione 1: Progettazione, SSD UC2\_AccessRoom - OP2}
   \begin{figure}
...
\begin{frame} {Iterazione 1: Progettazione, UC2\_AccessRoom - OP3}
   \begin{figure}
     \includegraphics[scale=0.10]{image_astah/Iteration_1_DesignModel/UC2_AccessRoom_SSD_3_notify.png}{\centering}
...
\begin{frame} {Iterazione 1: Progettazione, UC2\_AccessRoom - OP4}
   \begin{figure}
     \includegraphics[scale=0.165]{image_astah/Iteration_1_DesignModel/UC2_AccessRoom_SSD_4_sendCommand.png}{\centering}
...
\begin{frame} {Iterazione 1: Progettazione, UC2\_AccessRoom - OP5}
   \begin{figure}
     \includegraphics[scale=0.08]{image_astah/Iteration_1_DesignModel/UC2_AccessRoom_SSD_5_join_add.png}{\centering}
...
\begin{frame} {Iterazione 1: Progettazione, UC2\_AccessRoom - OP6}
   \begin{figure}
     \includegraphics[scale=0.07]{image_astah/Iteration_1_DesignModel/UC2_AccessRoom_SSD_6_notifypublic.png}{\centering}
...
\begin{frame} [allowframebreaks] {Refactoring Iterazione 1: Class Diagram Common UC1 e UC2}
   \begin{figure}
     \includegraphics[scale=0.16]{image_astah/Iteration_1_DesignModel_Refactored/ClassDiagramCommon.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Common }
...
\begin{frame} {Refactoring Iterazione 1: Class Diagram Snuc UC1 e UC2}
   \begin{figure}
     \includegraphics[scale=0.15]{image_astah/Iteration_1_DesignModel_Refactored/ClassDiagramSnuc.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Snuc }
...
\subsection{Refactoring Iterazione 1: SSD Diagram UC1 e UC2}
...
\begin{frame} {Refactoring Iterazione 1: UC2\_AccessRoom - OP2}
   \begin{figure}
     \includegraphics[scale=0.13]{image_astah/Iteration_1_DesignModel_Refactored/UC2_AccessRoom_SSD_2_getRoomsName.png}{\centering}
     \caption{SSD - OP2: getRoomsName() del modello di dominio (figura \ref{fig_UC2_AR_SSD}) }
...
\begin{frame} {Refactoring Iterazione 1: UC2\_AccessRoom - OP3}
   \begin{figure}
     \includegraphics[scale=0.09]{image_astah/Iteration_1_DesignModel_Refactored/UC2_AccessRoom_SSD_3_notify.png}{\centering}
     \caption{SSD - OP3: notify(list) del modello di dominio (figura \ref{fig_UC2_AR_SSD})}
...
\begin{frame} {Refactoring Iterazione 1: UC2\_AccessRoom - OP4}
   \begin{figure}
     \includegraphics[scale=0.17]{image_astah/Iteration_1_DesignModel_Refactored/UC2_AccessRoom_SSD_4_sendCommand.png}{\centering}
     \caption{SSD - OP4: sendCommand(cmd2) del modello di dominio (figura \ref{fig_UC2_AR_SSD}) }
...
\begin{frame} {Refactoring Iterazione 1: UC2\_AccessRoom - OP5}
   \begin{figure}
     \includegraphics[scale=0.10]{image_astah/Iteration_1_DesignModel_Refactored/UC2_AccessRoom_SSD_5_join_add.png}{\centering}
     \caption{SSD - OP5: joinRoom(sender,room), \newline addUserToRoom() del modello di dominio (figura \ref{fig_UC2_AR_SSD}) }
...
\begin{frame} {Refactoring Iterazione 1: UC2\_AccessRoom - OP6}
   \begin{figure}
     \includegraphics[scale=0.08]{image_astah/Iteration_1_DesignModel_Refactored/UC2_AccessRoom_SSD_6_notifypublic.png}{\centering}
     \caption{SSD - OP6: notifypublic(updateList) del modello di dominio (figura \ref{fig_UC2_AR_SSD}) }
...
\begin{frame} {Iterazione 2 Progettazione: UC3 Class Diagram - Connector}
   \begin{figure}
     \includegraphics[scale=0.115]{image_astah/Iteration_2_DesignModel/ClassDiagramConnector.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Connector }
     \label{fig_UC3_DCD_4} 
   \end{figure}
\end{frame}
...
\begin{frame} {Iterazione 2 Progettazione: UC3\_SendPublicMessage - OP1}
   \begin{figure}
     \includegraphics[scale=0.22]{image_astah/Iteration_2_DesignModel/UC3_SendPublicMessage_SSD_1_sendMsg.png}{\centering}
...
\begin{frame} {Iterazione 2 Progettazione: UC3\_SendPublicMessage - OP2}
   \begin{figure}
     \includegraphics[scale=0.13]{image_astah/Iteration_2_DesignModel/UC3_SendPublicMessage_SSD_2_publicMsg.png}{\centering}
...
\begin{frame} {Iterazione 3 Progettazione: UC4 Class Diagram - Connector}
   \begin{figure}
     \includegraphics[scale=0.12]{image_astah/Iteration_3_DesignModel/ClassDiagramConnector.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Connector }
     \label{fig_UC4_DCD_4} 
   \end{figure}
\end{frame}
...
\begin{frame} {Iterazione 3 Progettazione: UC4\_SendPrivateMessage - OP1}
   \begin{figure}
     \includegraphics[scale=0.20]{image_astah/Iteration_3_DesignModel/UC4_SendPrivateMessage_SSD_1_sendMsg.png}{\centering}
...
\begin{frame} {Iterazione 3 Progettazione: UC4\_SendPrivateMessage - OP2}
   \begin{figure}
     \includegraphics[scale=0.12]{image_astah/Iteration_3_DesignModel/UC4_SendPrivateMessage_SSD_2_privateMsg}{\centering}
