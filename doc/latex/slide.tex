...
\begin{frame} {Iterazione 1 Progettazione: UC1 e UC2 Class Diagram - Siuc Server}
   \begin{figure}
     \includegraphics[scale=0.28]{image_astah/Iteration_1_DesignModel/ClassDiagramSiucServer.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Siuc Server }
     \label{fig_UC1_UC2_DCD_2} 
   \end{figure}
\end{frame}

\begin{frame} {Iterazione 1 Progettazione: UC1 e UC2 Class Diagram - Siuc}
   \begin{figure}
     \includegraphics[scale=0.26]{image_astah/Iteration_1_DesignModel/ClassDiagramSiuc.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Siuc }
...
\begin{frame} {Refactoring Iterazione 1: UC1 e UC2 Class Diagram - Siuc}
   \begin{figure}
     \includegraphics[scale=0.235]{image_astah/Iteration_1_DesignModel_Refactored/ClassDiagramSiuc.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Siuc }
     \label{fig_UC1_UC2_DCDR_3} 
   \end{figure}
\end{frame}

\begin{frame} {Refactoring Iterazione 1: UC1 e UC2 Class Diagram - Siuc Server}
   \begin{figure}
     \includegraphics[scale=0.245]{image_astah/Iteration_1_DesignModel_Refactored/ClassDiagramSiucServer.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Siuc Server }
...
\begin{frame} {Descrizione Iterazione 2: Analisi - UC3\_SendPublicMessage}
  \emph{INSERIRE DESCRIZIONE}
\end{frame}
...
\begin{frame} {Iterazione 1 Progettazione: UC3 Class Diagram - Siuc}
   \begin{figure}
     \includegraphics[scale=0.24]{image_astah/Iteration_2_DesignModel/ClassDiagramSiuc.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Siuc }
     \label{fig_UC3_DCD_3} 
   \end{figure}
\end{frame}
...
\begin{frame} {Iterazione 2 Progettazione: UC3 Class Diagram - Siuc Server}
   \begin{figure}
     \includegraphics[scale=0.245]{image_astah/Iteration_2_DesignModel/ClassDiagramSiucServer.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Siuc Server }
     \label{fig_UC3_DCD_2} 
   \end{figure}
\end{frame}
...
\begin{frame} {Descrizione Iterazione 3: Analisi - UC4\_SendPrivateMessage}
  \emph{INSERIRE DESCRIZIONE}
\end{frame}
...
\begin{frame} {Iterazione 3 Progettazione: UC4 Class Diagram - Siuc}
   \begin{figure}
     \includegraphics[scale=0.235]{image_astah/Iteration_3_DesignModel/ClassDiagramSiuc.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Siuc }
     \label{fig_UC4_DCD_3} 
   \end{figure}
\end{frame}
...
\begin{frame} {Iterazione 3 Progettazione: UC4 Class Diagram - Siuc Server}
   \begin{figure}
     \includegraphics[scale=0.245]{image_astah/Iteration_3_DesignModel/ClassDiagramSiucServer.png}{\centering}
     \caption{DCD - Diagramma delle Classi: Package Siuc Server }
     \label{fig_UC4_DCD_2} 
   \end{figure}
\end{frame}
 ...
 \frametitle {\refname}
  \begin {thebibliography}{99}
   {\tiny 
     ...
     \newblock Indirizzo Web: \emph{\url{https://dellabate.wordpress.com/category/gof-pattern/ }}
   }
   \end {thebibliography}
\end {frame}
