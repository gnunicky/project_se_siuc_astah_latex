    ...
    \label{table:1}
     \resizebox{\linewidth}{!}{%
      \begin{tabular}{|l|p{10cm}|}\hline
       ...
       Pre-condizioni & L'utente inserisce correttamente i parametri della connessione al servizio di messaggistica  \\\hline
       Post-condizioni (garanzia di successo) &  L'utente è inserito tra gli utenti online con il nickname confermato del servizio di messaggistica ottenendo un 
                                                 messaggio di benvenuto \\\hline
       Scenario principale di successo &  
       \begin{enumerate} 
       \item L'utente inserisci un nickname, l'address e la porta del server.
       \item Il sistema esamina il nickname inviato dall'utente verifica se è presente una omonimia.
       \item Il sistema conferma inserimento tra gli utenti online inviando una notifica di benvenuto.
       \end{enumerate} \\\hline
      \end{tabular}}
   \end{table}
\end{frame}
      ...
      \resizebox{\linewidth}{!}{%
       \begin{tabular}{|l|p{10cm}|}\hline
         Estensioni (o flussi alternativi) &  
          \begin{enumerate} 
           \item (2A) Nel caso che è presente omonimia, cambia il nickname aggiungendo \_ al nickname, cioè nickname\_ . 
           \item  Il sistema conferma inserimento tra gli utenti online inviando una notifica di benvenuto.
          \end{enumerate} \\\hline
       ...
       Elenco delle varianti tecnologiche &  L’applicazione dovrebbe essere in grado di adattarsi graficamente in modo automatico al dispositivo con cui viene 
                                             utilizzata. \\\hline
     ...
     \resizebox{\linewidth}{!}{%
      \begin{tabular}{|l|p{10cm}|}\hline
       ...
       Parti interessate e interessi & 
        \begin{itemize}
         \item SiucUser: vuole registrarsi e effettuare l’ingresso in una stanza presente nel servizio di messaggistica.         
         \item SiucAdmin: E’ interessato che l’utente espulso non può registrarsi nella stanza selezionata. 
        \end{itemize} \\\hline
       Pre-condizioni &
        \begin{itemize}
         \item Nel sistema è presente almeno una stanza creata da un amministratore.
         \item Il sistema verifica che l’utente non sia stato espulso dalla stanza  
        \end{itemize} \\\hline
       ...
       \begin{tabular}{|l|p{10cm}|}\hline
          Scenario principale di successo &  
           \begin{enumerate} 
            ...
            \item Il sistema verifica l’esistenza della stanza.
            \item Il sistema registra l’utente alla stanza.
          \end{enumerate} \\\hline 
         Estensioni (o flussi alternativi) &  
          \begin{enumerate} 
           \item (4A) Se nel servizio di messaggistica non esiste una stanza con il nome specificato dall’utente.  
           \item L’interazione termina con la segnalazione dell’errore al sotto sistema chiamante e all’utente.
          \end{enumerate} \\\hline
       Requisiti speciali (Requisiti Non Funzionali) &  Comunicazione asincrona in cui lo scambio di informazioni avviene in tempo reale, senza sensibili pause tra 
                                                        invio e ricezione del messaggio\\\hline
       Elenco delle varianti tecnologiche &  L’applicazione dovrebbe essere in grado di adattarsi graficamente in modo automatico al dispositivo con cui viene 
      ...
      \resizebox{\linewidth}{!}{%
       \begin{tabular}{|l|p{10cm}|}\hline
        ...
        Pre-condizioni &
         \begin{itemize}  
          \item Nel sistema è presente almeno una stanza creata da un amministratore.
          \item L'utente è registrato nella stanza in cui desidera inviare i messaggi.
         \end{itemize} \\\hline
       ...
       \begin{tabular}{|l|p{10cm}|}\hline
         Elenco delle varianti tecnologiche &  
          \begin{itemize}  
           ...
           \item  L’applicazione dovrebbe essere in grado di adattarsi graficamente in modo automatico al dispositivo con cui viene utilizzata.
          \end{itemize} \\\hline
         Frequenza di ripetizione & Potrebbe essere quasi ininterrotta \\\hline
         Varie e/o Problemi Aperti &  // \\\hline
      \end{tabular}}
