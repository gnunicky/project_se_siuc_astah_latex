...
\begin{frame}{Iterazione 1: Requisiti, descrizione Mockups User Interface}
...
% ANALISI ITERAZIONE 1 UC1_RequestConnection
\subsection{Iterazione 1: Analisi - UC1\_RequestConnection}
\begin{frame} {Descrizione Iterazione 1: Analisi - UC1\_RequestConnection}
 \emph{INSERIRE DESCRIZIONE}
\end{frame}
...
\begin{frame} {Descrizione Iterazione 1: Analisi - UC2\_AccessRoom}
 \emph{INSERIRE DESCRIZIONE}
\end{frame}
...
\begin{frame} {Iterazione 1 Progettazione: UC1\_RequestConnection Connect}
   \begin{figure}
     \includegraphics[scale=0.08]{image_astah/Iteration_1_DesignModel/UC1_RequestConnection_SSD_3_4_connect.png}{\centering}
     \caption{SSD: UC1\_RequestConnection\_SSD\_3\_4\_connect}
     \framezoom <1><2>[border](0 cm,0.5 cm)(3.0 cm,3.0 cm)% primo quadrante a sx
     \label{fig_UC1_RC_SSD_3_4} 
   \end{figure}
\end{frame}
...
\section{Ideazione: Refactoring Iterazione 1}
\begin{frame} {Descrizione Ideazione: Refactoring Iterazione 1}
 \emph{INSERIRE DESCRIZIONE}
\end{frame}

\subsection{Iterazione 1 Refactoring: Progettazione}
\begin{frame} {Iterazione 1 Refactoring: Progettazione}
 \emph{INSERIRE DESCRIZIONE}
\end{frame}

\subsection{Iterazione 1 Refactoring: Implementazione - UC2\_AccessRoom}
\begin{frame} {Iterazione 1 Refactoring: Implementazione - UC2\_AccessRoom}
 \emph{INSERIRE DESCRIZIONE}
\end{frame}

\subsection {Iterazione 1 Refactoring: Test - UC2\_AccessRoom}
\begin{frame} {Iterazione 1 Refactoring: Test - UC2\_AccessRoom}
 \emph{INSERIRE DESCRIZIONE}
\end{frame}
...
\begin{frame} {Elaborazione: Iterazione 2}
  \emph{INSERIRE DESCRIZIONE}
\end{frame}

\subsection{Iterazione 2: Requisiti - UC3\_SendRoomMessage}
\begin{frame} {Iterazione 2: Requisiti - UC3\_SendRoomMessage}
  \begin{table}[!htbp]
...
\begin{frame} {Iterazione 2: Analisi}
  \emph{INSERIRE DESCRIZIONE}
\end{frame}

\subsection{Iterazione 2: Progettazione}
\begin{frame} {Iterazione 2: Progettazione}
  \emph{INSERIRE DESCRIZIONE}
\end{frame}

\subsection{Iterazione 2: Implementazione - UC3\_SendRoomMessage}
\begin{frame} {Iterazione 2: Implementazione - UC3\_SendRoomMessage}
  \emph{INSERIRE DESCRIZIONE}
\end{frame}

\subsection {Iterazione 2: Test - UC3\_SendRoomMessage}
\begin{frame} {Iterazione 2: Test - UC3\_SendRoomMessage}
  \emph{INSERIRE DESCRIZIONE}
\end{frame}
...
\begin{frame} {Iterazione 3: Analisi}
  \emph{INSERIRE DESCRIZIONE}
\end{frame}

\subsection {Iterazione 3: Progettazione}
\begin{frame} {Iterazione 3: Progettazione}
 \emph{INSERIRE DESCRIZIONE}
\end{frame}
